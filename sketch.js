...
function setup() {
	...
	mango2 = new Mango(1000,230,40);
	mango3 = new Mango(1050,360,36);
	mango4 = new Mango(1190,300,30);
	mango5 = new Mango(1100,300,30);
	mango6 = new Mango(1000,300,30);
	mango7 = new Mango(900,360,30);
	mango8 = new Mango(1300,370,30);  
	mango9 = new Mango(1270,280,30);
	mango10 = new Mango(1100,410,30);
	mango11 = new Mango(1200,230,40);


	
	chain = new Chain(stone.body,{x:200, y:500});
	tree = new Tree(1100,420);
...
function draw() {
    ...
    stroke("black");
    textSize(24);
    text("PRESS SPACE TO GET A  CHANCE TO PLAY", 200,300);
